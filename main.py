...
st.write("Enter the URL of a YouTube video from a podcast channel to extract its recommendations.")

# Your YouTube Data API key (you can also use environment variables or a config file)
...
# Auto-launch Streamlit app if not already running under Streamlit CLI
